...
define("NINJA_FORMS_UPLOADS_VERSION", 0.1);
...
require_once(NINJA_FORMS_UPLOADS_DIR."/includes/display/processing/featured-image.php");
...
function ninja_forms_add_upload_menu(){
	$uploads = add_submenu_page("ninja-forms", "File Uploads", "File Uploads", "administrator", "ninja-forms-uploads", "ninja_forms_admin");
