<div id="stepcondition">
  <div id="selectcondition" class="select">
    <label for="wdm-condiction"><?php _e("Please select Condiction"); ?></label>
    <select name="wdm-condiction">
      <option value=""><?php _e('Condition'); ?></option>
  ...
  <div id="selectyear" class="select">
    ...
    <select name="wdm-year">
      <option value=""><?php _e('Please select Year'); ?></option>
  ...
  <div id="selectstyle" class="select">
    ...
    <select name="wdm-style">
      <option value=""><?php _e('Please select style'); ?></option>
