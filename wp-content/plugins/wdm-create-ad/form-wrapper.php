...
<div class="formcarbonbackground">
  ...
  <div id="stepnavbar">
      ...
      <ul>
          <li class="<?php print ($step == 1) ? 'active' : 'off'; ?>"><span class="step">Step n&deg;1</span><br />
                              <span class="descriptionstep">Scegli la categoria</span>
          </li>
          <li class="<?php print ($step == 2) ? 'active' : 'off'; ?>"><span class="step">Step n&deg;2</span><br />
                              <span class="descriptionstep">Seleziona una o pi&ugrave; sottocategorie e <br />inserisci i dati dell“annuncio</span>
          </li>
          <li class="<?php print ($step == 3) ? 'active' : 'off'; ?>"><span class="step">Step n&deg;3</span><br />
                              <span class="descriptionstep">Dichiara lo stato d'uso <br />del tuo prodotto in vendita</span>
          </li>
          <li class="<?php print ($step == 4) ? 'active' : 'off'; ?>"><span class="step">Step n&deg;4</span><br />
                              <span class="descriptionstep">Carica al massimo <br />5 immagini</span>
          </li>
          <li class="<?php print ($step == 5) ? 'active' : 'off'; ?>"><span class="step">Step n&deg;5</span><br />
