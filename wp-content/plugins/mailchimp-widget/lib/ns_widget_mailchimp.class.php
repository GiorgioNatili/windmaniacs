			...
			if ($this->successful_signup) {
				...
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="<?php echo $this->id_base . '_form-' . $this->number; ?>" method="post">
					...
					?>
						...
						<label for="<?php echo $this->id_base; ?>-email-<?php echo $this->number; ?>"><?php echo __('Sign up for the weekly Newsletter. You will receive the best ads on Wind Maniac.', 'mailchimp-widget'); ?></label>
						<input id="<?php echo $this->id_base; ?>-email-<?php echo $this->number; ?>" type="text" name="<?php echo $this->id_base; ?>_email" placeholder="Please insert your email address" />
