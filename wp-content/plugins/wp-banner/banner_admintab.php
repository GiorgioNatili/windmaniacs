...
<div id="bannertabs">
     <ul>
         <li><a href="<?php echo WP_PLUGIN_URL .WP_BANNER . $query; ?>"><span><?php _e("Banner Admin", "banner");?></span></a></li>
         <!-- <li><a href="#bannerstat"><span><?php /* _e("Statistic", "banner"); */?></span></a></li> -->
     </ul>
   ...
   <!--  <div id="bannerstat" style="height: 538px; background-repeat:no-repeat;background-image: url(<?php echo WP_BANNER_PATH . "/images/graph.png" ?>)">
      <h3> <?php _e("planned for future release", "banner");?></h3>
      <p><?php _e("You can support the development with a donation", "banner");?></p>
      <p>
