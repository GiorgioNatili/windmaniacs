jQuery(document).ready(function(jQuery) {
	...
	jQuery(".ninja-forms-del-tag").live('click', function(e){
		e.preventDefault();
	...
	jQuery(".ninja-forms-terms-tab").live('click', function(e){
		e.preventDefault();
	...
	jQuery(".cat-checkbox").live('change', function(){
...
function ninja_forms_post_add_tag(tag){
	...
	if(add == 1){
		var html = '<span id="' + tag + '" style="display:none;"><a id="post_tag-' + count + '" class="ninja-forms-del-tag">X</a>&nbsp;' + tag + '</span>';
