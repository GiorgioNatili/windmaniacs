...
<?php
					    ...
					    <div class="box-author">
					    	...
					    	<ul>
					    		<li>First name:<span>&nbsp;<?php echo $curauth->first_name; ?></span></li>
					    		<li>Last name:<span>&nbsp;<?php echo $curauth->last_name; ?></span></li>
					    		<li>Email:<span>&nbsp;<?php echo antispambot($curauth->user_email); ?></span></a></li>
					    		<?php
					    	...
					    	<div class="button-author">
						    	<a href="<?php echo $curauth->user_url; ?>"><?php echo $curauth->first_name; ?>'S WEBSITE</a>
					    ...
					    <h2 style="margin-top: 20px;">Other product from: <?php echo $curauth->nickname; ?></h2>
