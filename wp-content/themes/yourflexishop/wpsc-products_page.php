    ...
    <?php if(($i % $productsperrow) == 1) echo '<ul class="product-list clearfix">'; ?>
      ...
      <?php if(wpsc_product_external_link(wpsc_the_product_id()) != '') : ?>
        ...
        <?php if(wpsc_show_thumbnails()) :?>
                <div class="product-meta" style="width:<?php echo get_option('product_image_width'); ?>px;height: 300<?php //echo get_option('product_image_height'); ?>px" >
        ...
        <?php endif; ?>
                ...
                <div class="overlay" style="height: 135px;">

                    <?php if ( !prima_get_option('productshideprice') ) : ?>
                        <div class="price">
                        <?php echo prima_the_product_price( prima_get_option('productsvariationtext'), $pricedecimal, get_the_ID(), $variationprice ); ?></div>
                    <?php endif; ?>
